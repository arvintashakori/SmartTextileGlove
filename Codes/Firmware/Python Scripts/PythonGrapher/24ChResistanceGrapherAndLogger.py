...
sensorPin22 = 23  # D6
sensorPin23 = 17   # D5
sensorPin24 = 9  # G3  remapped for conn 6
sensorPin25 = 6
sensorPin26 = 3  # F4
sensorPin27 = 12   # F3
sensorPin28 = 15   # F2
...
if (SENSOR_BLOCK_USED == 0): # SENSORS @ PINS 4-15
    p1 = win.addPlot(title="Sensor @ pin 2 (E5)")
    p2 = win.addPlot(title="Sensor @ pin 3 (D5)")
    p3 = win.addPlot(title="Sensor @ pin 4 (E6)")
    win.nextRow()
    p4 = win.addPlot(title="Sensor @ pin 5 (D6)")
    p5 = win.addPlot(title="Sensor @ pin 6 (E7)")
    p6 = win.addPlot(title="Sensor @ pin 7 (D7)")
    win.nextRow()
    p7 = win.addPlot(title="Sensor @ pin 9 (F7)")
    p8 = win.addPlot(title="Sensor @ pin 10 (G6)")
    #p9 = win.addLayout(row=3, col=2)

elif (SENSOR_BLOCK_USED == 1): # SENSORS @ PINS 16-27
    p1 = win.addPlot(title="Sensor @ pin 11 (F6)")
    p2 = win.addPlot(title="Sensor @ pin 12 (G5)")
    p3 = win.addPlot(title="Sensor @ pin 13 (F5)")
    win.nextRow()
    p4 = win.addPlot(title="Sensor @ pin 19 (D1)")
    p5 = win.addPlot(title="Sensor @ pin 20 (C1)")
    p6 = win.addPlot(title="Sensor @ pin 21 (D2)")
    win.nextRow()
    p7 = win.addPlot(title="Sensor @ pin 22 (C2)")
    p8 = win.addPlot(title="Sensor @ pin 23 (CD3)")

elif (SENSOR_BLOCK_USED == 2): # SENSORS @ PINS 28-33
    p1 = win.addPlot(title="Sensor @ pin 24 (C3)")
    p2 = win.addPlot(title="Sensor @ pin 26 (E3)")
    p3 = win.addPlot(title="Sensor @ pin 27 (F3)")
    win.nextRow()
    p4 = win.addPlot(title="Sensor @ pin 28 (E2)")
    p5 = win.addPlot(title="Sensor @ pin 29 (F2)")
    p6 = win.addPlot(title="Sensor @ pin 30 (E1)")
    p7 = win.addPlot(title="Sensor @ pin 31 (F1)")
...
def selectionchange (i):
    ...
    if SENSOR_BLOCK_USED == 0:
        p1.setTitle('Sensor @ pin 2 (E5)')
        p2.setTitle('Sensor @ pin 3 (D5)')
        p3.setTitle('Sensor @ pin 4 (E6)')
        p4.setTitle('Sensor @ pin 5 (D6)')
        p5.setTitle('Sensor @ pin 6 (E7)')
        p6.setTitle('Sensor @ pin 7 (D7)')
        p7.setTitle('Sensor @ pin 9 (F7)')
        p8.setTitle('Sensor @ pin 10 (G6)')
    elif SENSOR_BLOCK_USED == 1:
        p1.setTitle('Sensor @ pin 11 (F6)')
        p2.setTitle('Sensor @ pin 12 (G5)')
        p3.setTitle('Sensor @ pin 13 (F5)')
        p4.setTitle('Sensor @ pin 19 (D1)')
        p5.setTitle('Sensor @ pin 20 (C1)')
        p6.setTitle('Sensor @ pin 21 (D2)')
        p7.setTitle('Sensor @ pin 22 (C2)')
        p8.setTitle('Sensor @ pin 23 (D3)')
    elif SENSOR_BLOCK_USED == 2:
        p1.setTitle('Sensor @ pin 24 (C3)')
        p2.setTitle('Sensor @ pin 26 (E3)')
        p3.setTitle('Sensor @ pin 27 (F3)')
        p4.setTitle('NOT USED')
        p5.setTitle('NOT USED')
        p6.setTitle('NOT USED')
        p7.setTitle('Sensor @ pin 30 (E1)')
...
def update1():
    ...
    if SENSOR_BLOCK_USED == 0: # SENSORS @ PINS 4-15
        ch0.append(float(resistanceArray[sensorPin2]))
        ch1.append(float(resistanceArray[sensorPin3]))
        ch2.append(float(resistanceArray[sensorPin4]))
        ch3.append(float(resistanceArray[sensorPin5]))
        ch4.append(float(resistanceArray[sensorPin6]))
        ch5.append(float(resistanceArray[sensorPin7]))
        ch6.append(float(resistanceArray[sensorPin9]))
        ch7.append(float(resistanceArray[sensorPin10]))

    elif SENSOR_BLOCK_USED == 1: # SENSORS @ PINS 16-27
        ch0.append(float(resistanceArray[sensorPin11]))
        ch1.append(float(resistanceArray[sensorPin12]))
        ch2.append(float(resistanceArray[sensorPin13]))
        ch3.append(float(resistanceArray[sensorPin19])) # *****
        ch4.append(float(resistanceArray[sensorPin20]))
        ch5.append(float(resistanceArray[sensorPin21]))
        ch6.append(float(resistanceArray[sensorPin22]))
        ch7.append(float(resistanceArray[sensorPin23]))

    elif SENSOR_BLOCK_USED == 2: # SENSORS @ PINS 28-33
        ch0.append(float(resistanceArray[sensorPin24]))
        ch1.append(float(resistanceArray[sensorPin25]))
        ch2.append(float(resistanceArray[sensorPin26]))
        ch3.append(float(resistanceArray[sensorPin27]))
        ch4.append(float(resistanceArray[sensorPin28]))
        ch5.append(float(resistanceArray[sensorPin29]))
        ch6.append(float(resistanceArray[sensorPin30]))
        ch7.append(float(resistanceArray[sensorPin31]))
