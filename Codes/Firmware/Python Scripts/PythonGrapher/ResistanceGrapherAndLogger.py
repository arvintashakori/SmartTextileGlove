...
def selectionchange (i):
    ...
    if SENSOR_BLOCK_USED == 0:
        p1.setTitle('Sensor @ pin 4 (F7)')
        p2.setTitle('Sensor @ pin 5 (F6)')
        p3.setTitle('Sensor @ pin 6 (F5)')
        p4.setTitle('Sensor @ pin 10 (E7)')
        p5.setTitle('Sensor @ pin 11 (E6)')
        p6.setTitle('Sensor @ pin 12 (E5)')
        p7.setTitle('Sensor @ pin 14 (D7)')
        p8.setTitle('Sensor @ pin 15 (D6)')
    elif SENSOR_BLOCK_USED == 1:
        p1.setTitle('Sensor @ pin 16 (D5)')
        p2.setTitle('Sensor @ pin 17 (G3)')
        p3.setTitle('Sensor @ pin 19 (F4)')
        p4.setTitle('Sensor @ pin 20 (F3)')
        p5.setTitle('Sensor @ pin 21 (F2)')
        p6.setTitle('Sensor @ pin 23 (D3)')
        p7.setTitle('Sensor @ pin 24 (D2)')
        p8.setTitle('Sensor @ pin 27 (C4)')
...
def update1():
    ...
    if SENSOR_BLOCK_USED == 0: # SENSORS @ PINS 4-15
        ch0.append(float(resistanceArray[sensorPin4]))
        ch1.append(float(resistanceArray[sensorPin5]))
        ch2.append(float(resistanceArray[sensorPin6]))
        ch3.append(float(resistanceArray[sensorPin10]))
        ch4.append(float(resistanceArray[sensorPin11]))
        ch5.append(float(resistanceArray[sensorPin12]))
        ch6.append(float(resistanceArray[sensorPin14]))
        ch7.append(float(resistanceArray[sensorPin15]))

    elif SENSOR_BLOCK_USED == 1: # SENSORS @ PINS 16-27
        ch0.append(float(resistanceArray[sensorPin16]))
        ch1.append(float(resistanceArray[sensorPin17]))
        ch2.append(float(resistanceArray[sensorPin19]))
        ch3.append(float(resistanceArray[sensorPin33])) # *****
        ch4.append(float(resistanceArray[sensorPin21]))
        ch5.append(float(resistanceArray[sensorPin23]))
